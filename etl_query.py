...
# ✅ Find top 10 highest-paid employees (assuming column 'salary' exists)
print("💰 Finding top 10 highest-paid employees...")
top_earners = df_transformed.dropDuplicates(["full_name", "salary"]).orderBy(desc("salary")).limit(10)

top_earners.show(truncate=False)
